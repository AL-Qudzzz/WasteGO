...
export default function EWastePage() {
    const processSteps = [
        ...
        { number: '6', title: 'Penyaluran', description: 'Limbah elektronik disalurkan ke tujuan yang tepat' }
    ];
        ...
        <div className="flex flex-col min-h-screen bg-muted/20 text-foreground font-sans">
            ...
            <main className="flex-grow p-4 pb-24 overflow-y-auto">
                ...
                <div className="relative mb-6 pb-2">
                    <h1 className="text-2xl font-bold text-foreground">Electronic Waste</h1>
