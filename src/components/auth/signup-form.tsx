...
import { User, Mail, Eye, EyeOff, Phone, MapPin, Briefcase } from 'lucide-react';
      ...
      <form onSubmit={handleSignup} className="space-y-4">
        <div className="space-y-2">
          ...
          <div className="relative">
             ...
             <Input id="username" type="text" placeholder="Masukkan username Anda" required className="pl-10" />
          </div>
        </div>
        <div className="space-y-2">
        ...
        <div className="space-y-2">
          ...
          <div className="relative">
             ...
             <Input id="fullName" type="text" placeholder="Masukkan nama lengkap Anda" required className="pl-10" />
          </div>
        </div>
        <div className="space-y-2">
          ...
          <div className="relative">
             ...
             <Input id="phone" type="tel" placeholder="Masukkan nomor telepon Anda" required className="pl-10" />
          </div>
        </div>
        <div className="space-y-2">
          ...
          <div className="relative">
             ...
             <Textarea id="address" placeholder="" required className="pl-10 min-h-[100px] pt-3" />
          </div>
        </div>
        <div className="space-y-2">
          ...
          <div className="relative">
             <Mail className="absolute left-3 top-1/2 -translate-y-1/2 h-5 w-5 text-muted-foreground" />
             <Input id="postalCode" type="text" placeholder="Masukkan kode pos Anda" required className="pl-10" />
          </div>
        </div>
